<img width="2400" alt="Langfuse" src="https://github.com/user-attachments/assets/5810ae13-15d6-4b60-afd2-927adc501861" />
...
<div align="center">
  ...
  <div>
    ...
    <a href="https://github.com/yaxzh/langfuse-zh/issues"><strong>反馈汉化问题</strong></a> ·
    <a href="https://langfuse.com/issues"><strong>报告官方问题</strong></a> ·
...
<img width="2400" alt="Langfuse 核心功能" src="https://github.com/user-attachments/assets/0fad3dee-f3ad-423c-9f0d-7ccd0f26cc2d" />
...
- [评估](https://langfuse.com/docs/evaluation/overview) 是 LLM 应用开发流程的关键组成部分。Langfuse 支持 LLM-as-a-judge、代码评估器、用户反馈收集、人工标注，以及通过 API/SDK 构建自定义评估流程。
...
<img width="2400" alt="Langfuse 部署方式" src="https://github.com/user-attachments/assets/cf72e7f8-db7f-4e11-a2a1-ecfbe46f262c" />
...
> [!TIP]
> 自托管用户可以订阅 [Langfuse 自托管更新](https://langfuse.com/self-hosting#subscribe)，获取重要升级和安全信息。

## 🔌 集成

<img width="2400" alt="Langfuse 集成" src="https://github.com/user-attachments/assets/b85c9a45-68f0-4f76-b545-0e8632abef9f" />
...
| [Mastra](https://langfuse.com/docs/integrations/mastra)                              | JS/TS                  | 用于构建 AI Agent 和多 Agent 系统的开源 TypeScript 框架。                                                                        |
