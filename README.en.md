...
> [!IMPORTANT]
> This repository is a community-maintained Simplified Chinese fork of [Langfuse](https://github.com/langfuse/langfuse), not an official Langfuse distribution. The Web UI supports both English and Simplified Chinese.
